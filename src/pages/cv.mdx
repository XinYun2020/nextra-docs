...
<div className="flex flex-col gap-4">
  <img
    ...
    alternatively="Xinyun Zhang"
    className="w-32 mx-auto rounded-full"
  />
  <h1 className="text-center text-5xl font-plex italic font-semibold">Xinyun Zhang</h1>
...
- Designed and built new features for AngularJS and React.js applications, tool achieved reducing financial report errors.
...
- Technical Skills: TypeScript, React, Flask, Tailwind CSS, GitHub, Ansible, CouchDB, Docker, NLP Senmentic Anaylsis, MUI, Agile.
...
- Responsibilities:
  ...
  - Successfully delivered projects and optimized UI rendering efficiency, collaborating with internal and external team in agile scrum framework.
    ...
    - Resulted in faster access to data for the finance team, monitoring errors avoid financial impact, and investigating banking records, while actively engaging with team and optimizing UI rendering efficiency.
